...
- Resend: отправка с onboarding@resend.dev (нужно верифицировать домен для noreply@therapyvoid.com)
- Таблицы trial_sessions и email_codes создаются при старте сервера (auto-migrate)
